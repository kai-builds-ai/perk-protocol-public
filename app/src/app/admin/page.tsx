...
const MARKET_BLACKLIST = new Set<string>([
  ...
  'EPm6MYSVA2sDQvx4FWHX1YkNzgtsUnD7BquvPrJJZ68', // K too low (created before K fix deployed)
]);
...
function ToggleActive({
  ...
  return (
    <div className="bg-surface px-5 py-5 space-y-3">
      ...
      {/* collateral_mint is immutable after market creation — vault PDA mint cannot be changed */}
    </div>
  );
}
