...
///
/// NOTE: collateral_mint is intentionally NOT updatable. The vault PDA is
/// initialized with the collateral mint at market creation and its mint is
/// immutable. Changing the market's collateral_mint field without migrating
/// the vault causes MintMismatch errors on deposit/withdraw (Custom:3).
